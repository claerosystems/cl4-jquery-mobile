<!-- modules / cl4-jquery-mobile / cl4/orm_form_ul.php -->
...
if ($any_visible) {
	if ($form_options['display_buttons'] && $form_options['display_buttons_at_top']) {
		// the buttons
		echo '<div data-role="controlgroup" data-type="horizontal" class="cl4_buttons cl4_buttons_top">' . implode('', $form_buttons) . '</div>' . EOL;
	}
	?>
